				...
				while ( character !== null ) {
					...
					if ( matchState == KMP_MATCHED ) {
						...
						if ( highlightMatched !== false ){
							...
							this.hasMatchOptionsChanged( pattern, matchCase, matchWord );
						}
						return true;
					}
				}
			...
			contents: [ {
				...
				elements: [ {
					...
					},
					{
						...
						style: 'width:100%',
						label: lang.find,
						onClick: CKEDITOR.tools.debounce(findText,500),
					} ]
				},
				{
					type: 'fieldset',
			...
			},
			{
				...
				elements: [ {
					...
					},
					{
						...
						style: 'width:100%',
						label: lang.find,
						onClick: CKEDITOR.tools.debounce(replaceFindText,500),
					}]
				},
					{
						type: 'hbox',
						...
						children: [{
							...
							style: 'width:100%',
							label: lang.replace,
							onClick: CKEDITOR.tools.debounce(replaceText,500),
						}
						]
					},
					{	
						...
						children: [{
							type: 'button',
							id: 'btnReplaceAll',
							style: 'width:95px;margin-left:255px',
							label: lang.replaceAll,
							isChanged: false,
							onClick: CKEDITOR.tools.debounce(replaceAllText,500),
						}]
				},
				{
					type: 'fieldset',
